...
class LLMInferenceEngine(ABC):
    ...
    def _section_interaction_guidelines() -> str:
        return (
            ...
            "Use `memory_read` to recall what you already know. "
            "Use `memory_write` to save important knowledge for future sessions.\n\n"
            "Save to memory when:\n"
            "- The user asks you to remember something\n"
            "- The user corrects your behavior or states a preference\n"
            "- You learn something important about the user's environment or workflow\n\n"
