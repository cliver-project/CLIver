...
LLM_OPTIONS_KEYS: list[str] = ["temperature",
                               "max-tokens", "top-p", "frequency-penalty"]
...
def session(
    ...
    if frequency_penalty is not None:
        ...
        click.echo(
            f"Set frequency_penalty to {frequency_penalty} for this session.")
    ...
    if included_tools is not None:
        ...
        click.echo(
            f"Set included_tools to '{included_tools}' for this session.")
