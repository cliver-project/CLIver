...
You MUST follow these steps in order. Use `TodoWrite` to create a checklist from these steps and track your progress.
...
Fix any issues by rewriting the doc with `Write`.
